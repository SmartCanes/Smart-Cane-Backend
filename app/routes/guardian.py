...
def update_my_profile(guardian):
    ...
    try:
        ...
        if 'username' in data and data['username'] != guardian.username:
            existing_guardian = Guardian.query.filter_by(username=data['username']).first()
            if existing_guardian:
        ...
        for frontend_field, model_field in field_mapping.items():
            if frontend_field in data:
                ...
                if frontend_field == 'address' and isinstance(data[frontend_field], str):
...
def get_vip_guardians(guardian):
    ...
    try:
        ...
        all_vip_guardians = VIPGuardian.query.filter(VIPGuardian.vip_id.in_(vip_ids)).all()
        ...
        for g in guardians:
            ...
            guardian_info = {
                ...
                "relationship": vip_guardian.relationship_to_vip if vip_guardian else None,
